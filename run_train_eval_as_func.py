...
def run():
    ...
    def train_model(model, criterion, optimizer, scheduler, dataloaders, dataset_sizes, num_epochs=100):
        ...
        return model, loss_dict, acc_dict, best_acc
    ...
    # Train the model
    model_ft, loss_dict, acc_dict, best_acc = train_model(model_ft, criterion, optimizer_ft, exp_lr_scheduler, dataloaders, dataset_sizes, num_epochs=NUM_EPOCHS)
